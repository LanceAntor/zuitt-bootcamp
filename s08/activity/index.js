...
let artistsName = getArtistsArray();
...
function getMoviesArrayy(){
    let movies = ["The Lion King", "Meet the Robinsons", "Howl's Moving Castie", "Tangled", "Frozen"];
    return movies;
}

let moviesTitle = getMoviesArrayy();
...
let prime_nums = getPrimeNumberArray();
...
// BASE OF THE OUTPUT YOU GIVEN, I NOTICE THAT THERE IS NO TEMPLATE OF THIS ONE.
function blockSecret(){
    let secret = "Hidden Treasure";
    return "Block Secret Revealed:" + secret;
}
