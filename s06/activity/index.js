...
*/
let tempCelsius = 132;
console.log("132 degrees Celcius when converted in Farenheit is: \n");
let resultFahrenheit = (9/5 * tempCelsius) + 32;
...
let num8 = 348;
remainder1 = num8 % 4;
console.log("The remainder of 348 divided by 4 is: " + remainder1);
//Log the value of the remainder2 in the console.
