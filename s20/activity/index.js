...
function celsiusToFahrenheit(celsiusArray) {
    let convertedArray = celsiusArray.map(function(celsius) {
...
function areAllEven(values) {
    let isEven = values.every(function(value){
        return value % 2 === 0;
    });
    return isEven;
};
...
function hasDivisibleBy8(values){
    let hasDivisible = values.some(function(value){
        return value % 8 === 0;
    })
    return hasDivisible;
};
